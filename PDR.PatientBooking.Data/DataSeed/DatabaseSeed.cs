        ...
        private List<Order> AddOrders()
        {
            var orders = new List<Order>
            {
                new Order
                {
                    ...
                    StartTime = new DateTime(2021, 3, 11, 12, 15, 00),
                    EndTime = new DateTime(2021, 3, 11, 12, 30, 00)
                },
                new Order
                {
                    Id = Guid.Parse("57706153-7600-41fd-8a5e-dc60a584e21c"),
                    StartTime = new DateTime(2021, 3, 11, 12, 30, 00),
                    EndTime = new DateTime(2021, 3, 11, 12, 45, 00)
                },
                new Order
                {
                    Id = Guid.Parse("b6aad474-5b5d-42b7-a274-1a94f74ff69a"),
                    StartTime = new DateTime(2021, 3, 11, 14, 15, 00),
                    EndTime = new DateTime(2021, 3, 11, 14, 30, 00)
                },
                new Order
                {
                    Id = Guid.Parse("b67c2730-0c12-4236-9b1a-d5b1d22db247"),
                    StartTime = new DateTime(2021, 4, 11, 12, 15, 00),
                    EndTime = new DateTime(2021, 4, 11, 12, 30, 00)
                },
                new Order
                {
                    Id = Guid.Parse("31924ff1-c64e-4e1e-977e-704abc062aa4"),
                    StartTime = new DateTime(2021, 4, 12, 12, 15, 00),
                    EndTime = new DateTime(2021, 4, 12, 12, 30, 00)
                }
            };
